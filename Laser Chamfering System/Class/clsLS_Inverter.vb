...
Public Class clsLS_Inverter
    Private CommPort As New Comm()
    Private qCmd As New Queue
    Private ThreadDustInverter As Thread
    Private bThreadRunningDustInverter As Boolean
    Private nKillThreadDustInverter As Integer
    Private nDustInverterIndex As Integer = 0
    ...
    Public Function StartThread() As Boolean
        ...
        ThreadDustInverter = New Thread(AddressOf ThreadSub)
        nKillThreadDustInverter = 0
        ThreadDustInverter.SetApartmentState(ApartmentState.MTA)
        ThreadDustInverter.Priority = ThreadPriority.Lowest
        ThreadDustInverter.Start()
        StartThread = True
...
SysErr:
    ...
    Public Function EndThread() As Boolean
        ...
        Interlocked.Exchange(nKillThreadDustInverter, 1)
        If bThreadRunningDustInverter = True Then
            ThreadDustInverter.Join()
        End If
        ClosePort()

        ThreadDustInverter = Nothing
...
SysErr:
    ...
    Sub ThreadSub()
        ...
        While nKillThreadDustInverter = 0
            bThreadRunningDustInverter = True
            ...
            '    Status.RunFlag = btRtn(33).ToString & btRtn(34).ToString   ' 1 = 정지중 ,  2 = 운전중
        ...
        bThreadRunningDustInverter = False
        Exit Sub
SysErr:
        Dim str As String
        bThreadRunningDustInverter = False
...
SysErr:
    ...
    Dim nDustInverterFrq As Integer

    Public Sub SetDustInverterFreqSet()

        Dim nValue As Integer = nDustInverterFrq * 100
        ...
        bt(2) = Val("&H03")
        bt(3) = Val("&H7F")
        bt(4) = Hex(nValue.ToString.Substring(0, 2))
        bt(5) = Hex(nValue.ToString.Substring(2, 2))
